        ...
        <div className="flex gap-2 justify-center">
          ...
          {store?.whatsappNumber && (
            <Button
              ...
              className="relative flex items-center justify-center bg-green-600 hover:bg-green-700 text-white shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 rounded-full p-3"
              size="icon"
            >
              <svg 
                width="24" 
